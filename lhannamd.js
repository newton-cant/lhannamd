...
const todosmenu = `https://telegra.ph/file/6f159ffb328038ac9a685.jpg`
...
var myHari = ['Domingo', 'Segunta', 'Terça', 'Quarta', 'Quinta', 'Sexts', 'Sabado'];
var tgel = new Date();
...
const reply = (teks) => {
            supraz.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `Subscribe YouTube Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./LhannaMedia/theme/cheemspic.jpg`),"sourceUrl": `${linkz1}`}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            supraz.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `Subscribe YouTube Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./LhannaMedia/theme/cheemspic.jpg`),"sourceUrl": `${linkz2}`}}}, { quoted: m})
        }
        //auto reply by xeon
  //if (Autoreply) //remove forwad slashes to make it autoreply on off
        for (let anji of setik){
				if (budy === anji){
					result = fs.readFileSync(`./LhannaMedia/sticker/${anji}.webp`)
			...
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./LhannaMedia/audio/${anju}.mp3`)
			...
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./LhannaMedia/image/${anjh}.jpg`)
			  ...
			  //if (Autoreply) //remove forwad slashes to make it autoreply on off
				...
				if (budy === anjh){
					result = fs.readFileSync(`./LhannaMedia/video/${anjh}.mp4`)
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./LhannaMedia/theme/cheemspic.jpg'), `${watermark}`, `${botname}`, "916909137213@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
// FAKE TEXT IMG
const textImg = (teks) => {
supraz.sendMessage(m.chat, { text :teks, }, {quoted: m, thumbnail: fs.readFileSync('./LhannaMedia/image/wpmobile.png')}) 
}
...
//fake gif by xeon
	 ...
	 message: { 
                 ...
                 'gifPlayback': 'true', 
                 'caption': `Xeon`,
                 'jpegThumbnail': fs.readFileSync('./LhannaMedia/theme/Cheems-bot.mp4')
                        }
                       }
	                  } 
//FAKEREPLY TROLI
...
│
└─「 𝐋𝐇𝐀𝐍𝐍𝐀-𝐌𝐃 」       
│𝗩𝗲𝗹𝗼𝗰𝗶𝗱𝗮𝗱𝗲 : ${latensie.toFixed(4)} seg
│𝗡𝗼𝗺𝗲𝗕𝗢𝗧 : ${global.botname}
│𝗖𝗿𝗶𝗮𝗱𝗼𝗿 : ${global.ownername}
│𝗡𝘂𝗺𝗲𝗿𝗼 : ${global.ownernummenu}
│𝗛𝗼𝘀𝗽𝗲𝗱𝗮𝗱𝗼 : ${os.hostname()}
│𝗣𝗹𝗮𝘁𝗮𝗳𝗼𝗿𝗺𝗮  : ${os.platform()}
│𝗧𝗼𝘁𝗮𝗹 𝗨𝘀𝘂𝗮𝗿𝗶𝗼𝘀: ${Object.keys(global.db.users).length}
│𝗧𝗼𝘁𝗮𝗹 𝗔𝗰𝗲𝗿𝘁𝗼𝘀 : ${jumlahcmd}
│𝗧𝗼𝘁𝗮𝗹 𝗔𝗰𝗲𝗿𝘁𝗼𝘀 𝗱𝗶𝗮𝘀 : ${jumlahharian}
│
└─「 𝗨𝘀𝘂𝗮𝗿𝗶𝗼𝘀 𝗟𝗲𝘃𝗲𝗶𝘀 」
│𝗦𝗲𝘂 𝗟𝗲𝘃𝗲𝗹 : ${levelMenu}
│𝗦𝗲𝘂 𝗫𝗽 : ${xpMenu}\ ${reqXp}
...
thumbnail: fs.readFileSync("LhannaMedia/theme/cheemspic.jpg"),
mediaType:1,
                ...
                const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedContentText: menulist,
                            hydratedButtons: [	
            { urlButton: { displayText: `YouTube 🍒`, url : `${websitex}` } },
            { urlButton: { displayText: `Site Api 🍜`, url: `${botscript}` } },
            { quickReplyButton: { displayText: `Supra 📕`, id: 'al'} },
            { quickReplyButton: { displayText: `List Menu 🍢`, id: 'listamenu'} },
...
case 'me': case 'inventory': case 'profile':{
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let butRun = [
        	...
        	supraz.sendMessage(m.chat, { caption: teksehmazeh, document: fs.readFileSync('./LhannaMedia/theme/cheems.xlsx'), mimetype: `${docs}`, fileName: `Want to adventure again?`, templateButtons: butRun, footer: `${botname}`, mentions: [m.sender] })
        	}
        	break
 case 'banchat': {
 if (isBan) return reply(mess.ban)	 			
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
let mdss = await fetchJson(`https://software-search.herokuapp.com/puxar?type=cpf3&q=${q}&token=Q9b5wQMcOug3`)
casas = `               🔍 𝘿𝘼𝘿𝙊𝙎 𝘾𝙋𝙁 🔍

`
reply(casas+mdss.resultado)
break

case 'telefone':
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
let mdssm = await fetchJson(`https://software-search.herokuapp.com/puxar?type=telefone&q=${q}&token=Q9b5wQMcOug3`)
casas = `            🔍 𝘿𝘼𝘿𝙊𝙎 𝙏𝙀𝙇𝙀𝙁𝙊𝙉𝙀 🔍

`
reply(casas+mdssm.resultado)
break
...
if (!isBotAdmins) return reply(mess.botAdmin)
if (!isAdmins && !isCreator) return reply(mess.admin)
if (args.length < 1) return reply('digite on para ativar, off para desativar')
if (args[0]  === 'on'){
if (isAutoSticker) return reply(`Já ativado`)
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./LhannaMedia/theme/cheemsthumb.jpg'), `${global.watermark}`, `${global.botname}`, "916909137213@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await supraz.groupAcceptInvite(vcc).then(async(res) => replay(jsonformat(res))).catch(_ => _)
replay("Succes!")
} else {
...
spawn('convert', [
'./LhannaMedia/image/magernulis.jpg',
'-fill',
codewarn,
'-font',
'./LhannaMedia/font/nulis.ttf',
'-size',
'1024x784',
'-pointsize',
'20',
   ...
   if (isBan) return reply(mess.ban)
	...
	//let randoms = dddss[Math.floor(Math.random() * dddss.length)]
                ...
                case 'telesticker':{
                   ...
                   let ini_sticker = suprafc.sticker
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    ...
                    sections: [{
							...
							{
								"title": "Recursos de bot ❤️",
								"rows": [
									{
										"title": "Todos Comandos 🥀",
										...
										},
									{
										...
										{
										"title": "Rpg Menu 🏞️",
										"description": "Exibe a lista de recursos de RPG",
...
case 'allmenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
var unicorn = await getBuffer(todosmenu)
...
if (!m.isGroup) return
if (m.key.fromMe) return
sendNye = fs.readFileSync('./LhannaMedia/theme/yourtag.webp')
